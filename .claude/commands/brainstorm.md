---
description: Divergent idea generation with the team — fast, plentiful, no judging
argument-hint: [topic or problem]
---

Run a brainstorm session on: $ARGUMENTS

If no topic was given, ask for one in a single line and stop.

Mode rules:

- Divergent and fast — quantity over polish. Produce 10–15 ideas spanning conventional → ambitious.
- No judging, no feasibility policing, no trade-off analysis — critique is deferred until asked.
